...
<body class="guide-background">
           ...
           <p class="word2">
                        1. Register and upload your artwork on <a style="color:#f2f2f2;" href="home.php">ART<strong>EASY</strong>.</a><br>
                        2. Ship the artwork to the buyer.<br>
                        3. Receive 80% of the selling price.<br>
            </p>

            <h3 class="word1">How do I apply to exhibit my artwork at ART<strong>EASY</strong></h3>
            ...
            <h3 class="word1">What is your commission structure?</h3>
                <p class="word2"> Art<strong>EASY</strong> Gallery will pay you 80% of the selling price.  Pay for shipping and get your profit!<br><br>

            Example 1:<br>
            You live in Hyderab City.<br>
            A buyer from Delhi purchased one of your artworks.<br>
            Selling price: 42,500.<br>
            You keep 80% of this amount: 34,000. This is the amount you will receive from us.<br>
            You pay the shipping costs: 1,000. (based on Fedex rates in February 2014 for a 2kg or 4.5lbs weight artwork).<br>
            Your profit: 33,000.<br><br>


            Example 2:<br>
            You live in Chennai City.<br>
            A buyer from Hyderabad City purchased one of your artworks.<br>
            Selling price: 75,000.<br>
            You keep 80% of this amount: 60,000. This is the amount you will receive from us.<br>
            You pay the shipping costs: 5,000 (based on Fedex rates in February 2014 for a 2kg or 4.5lbs weight artwork).<br>
            Your profit: 55, 000.</p>
            ...
            <h3 class="word1" >Where is ART<strong>EASY</strong>  based?</h3>
                <p class="word2">Our main office is located in VIT,Vellore although we are primarily a virtual gallery.</p>

            <h3 class="word1">If I exhibit my work at ART<strong>EASY</strong>, may I seek other gallery representation?</h3>
                <p class="word2">Yes.</p>
            ...
            <h3 class="word1">Can clients living outside of the United States purchase my art on ART<strong>EASY</strong>?</h3>
                <p class="word2">No! We don't allow international customers.</p>

            <h3 class="word1">How do I submit more art if I am already exhibiting my work at ART<strong>EASY</strong>?</h3>
