...
<head>
    ...
    <style type="text/css">
        body {
                ...
                background: url(pictures/pic12.jpg) no-repeat fixed;
  ...
  <div class="dpdown-content" style="left:0;">
                   <a href="artworks.php">Artworks</a>
                    <a href="artist.php">Artists</a>
                     ...
                     ------------------------------------<br>
                    <a href="about_us.php"> About ARTEASY</a>
  </div>
</div>
...
//<a href= "pictures/arts/'.$row[0].'">
  ...
  <ul class="ul" >
         ...
         <h1 class="ART">ART </h1>
  <h1 class="_BAY">GALLERY </h1>

  <h2 class="Albay_">Your </h2>
  <h2 class="Original_">Very Own </h2>
  <h2 class="Artworks_">ArtSpace </h2>
