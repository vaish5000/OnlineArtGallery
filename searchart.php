...
<body>
  ...
  <option value="">FOR SCULPTURE MEDIUM </option>
      ...
      <option value="">FOR PHOTOGRAPHY MEDIUM</option>
                 ...
                 <option value="5001">less than 5,000 Rs</option>
                 <option value="10001">less than 10,000 Rs</option>
                 <option value="50001">less than 50,000 Rs</option>
                 <option value="500001">less than 500,000 Rs</option>
                  <option value="1000001">less than 1,000,000 Rs</option>
...
$price = $_POST['Price'];
            ...
            $query_category="SELECT art_work.art_imagepath,art_work.art_id, art_work.art_title,art_work.art_price, user.user_fname, user.user_mname,user.user_lname,art_work.art_description,art_work.art_imagepath,art_work.art_category
                         FROM art_work,user
                        where art_work.user_id = user.user_id AND (art_category = '$category') AND (art_media = '$medium') AND (art_price between 0 AND '$price') GROUP BY art_work.art_id ORDER BY art_work.art_title ASC
                            ";
