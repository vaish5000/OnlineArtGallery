...
$sql="INSERT INTO user (username,password,USER_FNAME,USER_MNAME,USER_LNAME,USER_GENDER,USER_AGE,USER_BDAY,USER_CONTACT,USER_CITY,USER_STATE,USER_PINCODE,USER_CODE,USER_STREET,USER_HOUSE_NUMBER,USER_IMAGEPATH,USER_TYPE,USER_EMAIL) VALUES ('$username','$password','$USER_FNAME', '$USER_MNAME','$USER_LNAME','$USER_GENDER',
...
<div class="border">
      ...
      <form action = "create_account.php"enctype="multipart/form-data" method="POST">
           ...
           <p class="fsize-text"> Username: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" required name="username" ><br><br>
            ...
            Pincode:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="zipcode" name="zipcode"><br><br>
